...
function ResultsNegativeScreen(props) {
  return (
      ...
      <View style={styles.view7}>
        <View style={styles.view8}>
          ...
          <View style={styles.view9}>
            <Text>Confirmed Negative For FMD !</Text>
          </View>
          <View style={styles.view9}>
            <Text>You can use these tips to keep cattle safe</Text>
          </View>
        </View>
...
export default ResultsNegativeScreen;